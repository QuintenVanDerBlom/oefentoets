    ...
    <div class="container mx-1">
        ...
        <form id="form" class="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight
                    focus:outline-none focus:shadow-outline" name="price" id="price"
                        value="{{ $product->latest_price->price }}" type="text" disabled>
            </div>
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight
                    focus:outline-none focus:shadow-outline" name="category_id" id="category_id"
                       value="{{ $product->category->name }}" type="text" disabled>
            </div>
